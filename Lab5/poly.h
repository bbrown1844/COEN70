...
//  2. The exponents of the polynomial are the index of the array while the
//     coefficients of the polynomial are the values of the array at the index
//  3. A polynomial is declared as the zero polynomial.
//  4. 
//
//
//
