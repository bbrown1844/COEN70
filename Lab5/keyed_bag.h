...
//      Precondition: otherBag.size() is greater than 0.
//      Postcondition: Returns true if there is a duplicate key otherwise returns false.
//
...
//
// Invariant:
//  1. Number of items is in the variable used.
//  2. In an empty bag, the data in the array doesn't matter. In a non-empty bag
//     items are stored in data[0] through data[used-1].
//
