...
//     next node. The type of the data is defined as node::Item in a
//     typedef statement. The Item may be any
...
#pragma mark - Linked List Functions
    ...
    template <class Item>
    void list_head_insert(node<Item>*& head_ptr, const /*typename node<Item>::*/Item& entry);
    template <class Item>
    void list_insert(node<Item>* previous_ptr, const typename node<Item>::Item& entry);
    template <class Item>
    node<Item>* list_search(node<Item>* head_ptr, const typename node<Item>::Item& target);
    template <class Item>
    const node<Item>* list_search(const node<Item>* head_ptr, const typename node<Item>::Item& target);
    template <class Item>
