...
template <class Item>
node_iterator<Item>  sequence<Item>::begin( ){
    node_iterator<Item>* iterator = new node_iterator<Item>(head_ptr);
    return *iterator;
}

template <class Item>
const_node_iterator<Item> sequence<Item>::begin( ) const{
  const_node_iterator<Item>* iterator = new const_node_iterator<Item>(head_ptr);
  return *iterator;
}

template <class Item>
node_iterator<Item> sequence<Item>::end( ){
  node_iterator<Item>* iterator = new node_iterator<Item>(tail_ptr);
  return *iterator;
}

template <class Item>
const_node_iterator<Item> sequence<Item>::end( ) const{
  const_node_iterator<Item>* iterator = new const_node_iterator<Item>(tail_ptr);
  return *iterator;
}
